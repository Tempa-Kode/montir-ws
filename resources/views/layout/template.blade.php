        ...
        <div class="connect-container align-content-stretch d-flex flex-wrap">
            <div class="page-sidebar">
                ...
                <div class="page-sidebar-inner slimscroll">
                    <ul class="accordion-menu">
                        ...
                        <li class="{{ Route::currentRouteName() === 'transaksi.index' ? 'active-page' : '' }}">
                            <a href="{{ route('transaksi.index') }}"><i class="material-icons">cloud_queue</i>Transaksi</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="page-container">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item nav-profile dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ asset('images/avatars/profile-image-1.png') }}" alt="profile image">
                ...
                <div class="page-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="footer-text">2025 © Aprilmen Sihaloho</span>
                        </div>
                    </div>
                </div>
            </div>
